...
def plotSingleHistogram(et, eta, model_idx, df, data, sort):
	...
	sgnRings1=data[target == 1, 9:75]
	sgnRings2=data[target == 1, 83:101]
	sgnRings=np.concatenate((sgnRings1, sgnRings2), axis=1)
	bkgRings1=data[target != 1, 9:75]
	bkgRings2=data[target != 1, 83:101]
	bkgRings=np.concatenate((bkgRings1, bkgRings2), axis=1)
...
etabins_values = [0,0,0,0,2.37, 2.50]
